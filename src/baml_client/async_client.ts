...
import type { Audio, BamlCtxManager, BamlRuntime, ClientRegistry, FunctionLog, FunctionResult, HTTPRequest, Image, Pdf, Video } from "@boundaryml/baml"
import {
  BamlAbortError,
  BamlStream,
  Collector,
...
export class BamlAsyncClient {
  ...
  async SummarizeArticle(
    ...
    try {
      ...
      if (options.onTick) {
        const stream = this.stream.SummarizeArticle(articles, __baml_options__);
        ...
        onTickWrapper = () => {
          ...
          if (log) {
            try {
              ...
              console.error(
                "Error in onTick callback for SummarizeArticle",
                error
              );
            }
          }
