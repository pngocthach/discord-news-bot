...
export default class TypeBuilder {
  ...
  Article: ClassViewer<"Article", "title" | "snippet" | "content">;

  DailyDigest: ClassViewer<
    "DailyDigest",
    "digest_title" | "overview" | "main_stories" | "other_topics"
  >;

  MainStory: ClassViewer<"MainStory", "headline" | "summary" | "category">;

  OtherTopic: ClassViewer<"OtherTopic", "topic" | "brief_update">;

  constructor() {
    this.tb = new _TypeBuilder({
      classes: new Set(["Article", "DailyDigest", "MainStory", "OtherTopic"]),
      enums: new Set([]),
